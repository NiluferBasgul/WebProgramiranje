...
@WebServlet(name="listStudents_servlet",urlPatterns = "/servlet/listStudents")
public class listStudentsServlet {
    private final StudentService studentService;

    public listStudentsServlet(StudentService studentService) {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, InvalidCredentialsException {
